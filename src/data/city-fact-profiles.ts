...
const PROFILES: readonly CityFactProfile[] = [
  profile({
    ...
    paragraphs: [
      ...
      "덕양구, 일산동구, 일산서구 중 어느 구인지 적고 가까운 하천·공원·시설 이름을 보조 기준으로 붙여 주세요.",
    ],
    addressAxes: ["행주산성·한강", "창릉천·북한산", "일산호수공원·킨텍스"],
    sections: [
      { id: "haengju-changneung", heading: "행주산성과 창릉천 쪽 주소", paragraphs: ["덕양구 주소는 행주산성·한강 쪽인지 창릉천·북한산 쪽인지부터 확인합니다.", "도로명과 가까운 하천 또는 산 이름을 함께 받으면 덕양구 안에서도 기준이 분명해집니다."] },
      { id: "ilsan-lake-kintex", heading: "일산호수공원과 킨텍스 주변", paragraphs: ["일산 주소는 호수공원·장항습지·킨텍스 가운데 가까운 기준점을 적어 두면 좋습니다.", "일산동구와 일산서구를 먼저 구분한 뒤 동 이름과 건물명을 확인합니다."] },
      ...
      { id: "river-mountain-axis", heading: "한강과 북한산 사이의 기준점", paragraphs: ["남쪽 한강 변과 동쪽 북한산 자락은 서로 다른 방향의 주소를 가리키는 기준점입니다.", "행주·창릉·일산 중 가까운 생활권을 먼저 말한 뒤 상세 주소를 확인합니다."] },
    ],
    sources: [
  ...
  profile({
    ...
    sections: [
      ...
      { id: "cheonggyesan-hyanggyo", heading: "청계산과 과천향교 쪽 주소", paragraphs: ["청계산·과천향교는 동쪽과 구도심 주소를 설명할 때 쓰는 기준점입니다.", "가까운 지하철역과 도로명을 함께 적으면 시설명이 같은 장소를 피할 수 있습니다."] },
    ],
  ...
  profile({
    ...
    paragraphs: ["남한산성, 경안천, 곤지암, 남종·팔당호 수변처럼 서로 떨어진 기준점으로 주소 범위를 확인합니다.", "읍·면·동 이름에 가까운 하천·산성·수변 지명을 덧붙이면 같은 이름의 다른 지역과 구분하기 좋습니다."],
    addressAxes: ["남한산성", "경안천", "곤지암", "남종·팔당호"],
    sections: [
      { id: "namhansanseong", heading: "남한산성 생활권의 주소", paragraphs: ["남한산성 주변은 산성 진입로와 면·동 이름을 함께 봐야 하는 주소권입니다.", "산성 쪽이라는 설명에 도로명이나 가까운 마을 이름을 더해 주세요."] },
      ...
      { id: "paldang-waterfront", heading: "남종과 팔당호 수변 주소", paragraphs: ["남종면 일대는 팔당호 수변 지명이 주소 확인에 직접 도움이 되는 곳입니다.", "면·리 이름과 가까운 수변 도로를 적어 도심 주소와 섞이지 않게 합니다."] },
  ...
  profile({
    ...
    paragraphs: ["문수산·한강하구 쪽, 대명항 쪽, 아라뱃길·아라마리나 쪽을 각각 주소 기준으로 삼습니다.", "읍·면·동과 도로명에 가까운 수변·항구·산 이름을 더해 정확한 위치를 알려 주세요."],
    addressAxes: ["문수산·한강하구", "대명항", "아라뱃길·아라마리나"],
    sections: [
      { id: "munsu-estuary", heading: "문수산과 한강하구 쪽 주소", paragraphs: ["문수산과 한강하구는 북부 읍·면 주소를 확인할 때 쓰는 지형 기준입니다.", "읍·면과 리 이름 뒤에 가까운 산이나 하구 지명을 덧붙여 주세요."] },
      ...
      { id: "ara-waterway", heading: "아라뱃길과 아라마리나 주변", paragraphs: ["아라뱃길·아라마리나는 남부 도시권에서 수변 방향을 알려 주는 기준점입니다.", "고촌·풍무·사우 등 동네 이름과 가까운 교량이나 큰길을 함께 적어 주세요."] },
  ...
  profile({
    ...
    sections: [
      { id: "achasan-mangusan", heading: "아차산과 망우산 쪽 주소", paragraphs: ["아차산·망우산 자락은 교문·인창 쪽 주소를 설명하는 산 기준입니다.", "등산로 이름 대신 동과 도로명, 가까운 건물을 먼저 확인합니다."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "geumjeong-dangjeong", heading: "금정역과 당정 쪽 주소", paragraphs: ["금정·당정 주소는 금정역, 군포역, 당정역 중 가까운 철도 기준을 확인합니다.", "역 이름 뒤에 동과 도로명을 이어 적어 주세요."] },
  ...
  profile({
    ...
    paragraphs: ["다산·별내, 진접·오남, 화도·와부는 왕숙천·한강·북한강을 따라 서로 다른 주소 축을 이룹니다.", "읍·면·동 이름에 가까운 하천·철도역·도로명을 붙여 넓은 시역 안의 주소를 좁힙니다."],
    addressAxes: ["다산·한강", "왕숙천·진접", "별내·청학", "화도·와부·북한강"],
    sections: [
      { id: "dasan-hangang", heading: "다산과 한강 쪽 주소", paragraphs: ["다산·수석 쪽은 한강공원과 왕숙천 합류 방향을 기준으로 주소를 확인합니다.", "동 이름과 가까운 교량 또는 큰길을 함께 알려 주세요."] },
  ...
  profile({
    ...
    paragraphs: ["상봉암·소요산 쪽, 보산 관광특구 쪽, 신천과 경원선 주변을 나눠 주소를 봅니다.", "동 이름에 소요산역·보산역·지행역 같은 가까운 역이나 신천 쪽이라는 기준을 함께 적어 주세요."],
    ...
    sections: [
      ...
      { id: "bosan-zone", heading: "보산 관광특구 주변 주소", paragraphs: ["보산동 관광특구는 신천, 평화로, 경원선 철로를 둘러싼 기준으로 안내됩니다.", "보산역과 중앙로 가운데 가까운 곳을 덧붙이면 도심 주소를 구분하기 쉽습니다."] },
  ...
  profile({
    ...
    paragraphs: ["원미·소사·오정 세 구를 먼저 고르고 1호선 역세권, 성주산, 북부 생활권 가운데 가까운 기준을 확인합니다.", "부천역이나 소사역 같은 역 이름만 쓰지 말고 구·동·도로명을 순서대로 적습니다."],
    addressAxes: ["원미·중동", "소사·성주산", "오정·원종", "1호선 역세권"],
    sections: [
      { id: "wonmi-center", heading: "원미구 도심 주소", paragraphs: ["원미구는 부천역·중동역과 원미·상동 생활권을 기준으로 주소를 봅니다.", "부천역과 중동역 중 가까운 철도 기준에 동·도로명·건물명을 더합니다."] },
      { id: "sosa-seongjusan", heading: "소사구와 성주산 쪽 주소", paragraphs: ["소사구는 소사역·부천역 남쪽과 성주산 자락을 기준으로 확인합니다.", "소사라는 이름만 적지 말고 동과 가까운 역 또는 큰길을 함께 알려 주세요."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "jungwon-tancheon", heading: "중원구와 탄천 동쪽 주소", paragraphs: ["중원구는 성남동·중앙동·은행동과 탄천·검단산 방향을 기준으로 주소를 봅니다.", "성남동·중앙동·은행동 가운데 해당 동과 가까운 역·도로명을 붙입니다."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "gaetgol", heading: "시흥갯골 주변 주소", paragraphs: ["시흥갯골은 장곡·월곶·능곡 사이에서 수변 방향을 알려 주는 기준입니다.", "갯골공원 이름만 적지 말고 장곡·월곶·능곡 중 가까운 동과 도로명을 붙입니다."] },
      { id: "sorae-sincheon", heading: "소래와 신천 도심 주소", paragraphs: ["신천·대야·은행 생활권은 소래 쪽 도심 주소로 이어집니다.", "신천·대야·은행 중 해당 행정동과 가까운 역을 함께 적습니다."] },
  ...
  profile({
    ...
    sections: [
      { id: "sangnok-surambong", heading: "상록구와 수암봉 쪽 주소", paragraphs: ["상록구는 본오·사동·일동과 수암봉 방향을 기준으로 주소를 나눠 봅니다.", "본오·사동·일동 중 해당 동과 가까운 역 또는 큰길을 덧붙여 주세요."] },
      ...
      { id: "two-gu-order", heading: "상록과 단원부터 구분하기", paragraphs: ["안산 주소는 상록구와 단원구 중 어느 구인지가 첫 단계입니다.", "상록·단원을 고른 다음 동, 도로명, 건물명을 순서대로 확인합니다."] },
    ],
    sources: [
  ...
  profile({
    ...
    sections: [
      { id: "seoun-cheongnyong", heading: "서운산과 청룡호수 쪽 주소", paragraphs: ["서운산·청룡호수 주변은 서운면과 동남쪽 마을 주소를 설명하는 기준입니다.", "서운면과 리 이름에 가까운 호수 또는 산길을 더해 주세요."] },
  ...
  profile({
    ...
    paragraphs: ["만안구·동안구를 먼저 고르고 안양천·학의천, 관악산·수리산, 평촌 가운데 가까운 기준을 확인합니다.", "구와 동을 적은 뒤 역·하천·산 이름은 상세 도로명을 보완하는 데 사용합니다."],
    addressAxes: ["만안구·안양천", "동안구·평촌·학의천", "관악산·수리산", "만안·동안"],
    sections: [
      { id: "manan-anyangcheon", heading: "만안구와 안양천 쪽 주소", paragraphs: ["만안구는 안양역·명학역과 안양천, 관악산 자락을 기준으로 주소를 봅니다.", "안양역·명학역 중 가까운 곳과 구도심 동·도로명을 함께 확인합니다."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "jangheung-gwangjeok", heading: "장흥과 광적의 서부 주소", paragraphs: ["장흥·광적은 면 이름 아래 리와 도로가 이어지는 주소 구조입니다.", "장흥면·광적면 가운데 해당 면을 고르고 리와 가까운 큰길을 함께 알려 주세요."] },
  ...
  profile({
    ...
    sections: [
      { id: "imjin-river", heading: "임진강을 따라 보는 주소", paragraphs: ["임진강은 군남·왕징·미산·백학 쪽 주소를 설명하는 대표 하천 기준입니다.", "군남·왕징·미산·백학 중 해당 면과 리 이름에 가까운 교량 또는 강변 도로를 더해 주세요."] },
      ...
      { id: "civilian-control", heading: "민통선 인접 주소 확인", paragraphs: ["일부 북부 지역은 일반 생활권과 출입 확인이 필요한 구역이 함께 있습니다.", "출입 가능 여부를 단정하지 않고 정확한 면·리와 목적지의 공식 안내를 먼저 확인합니다."] },
    ],
    sources: [
  ...
  profile({
    ...
    sections: [
      { id: "osan-stream", heading: "오산천을 따라 보는 도심 주소", paragraphs: ["오산천은 중앙동·대원동·신장동 주변을 남북으로 확인하는 하천 기준입니다.", "중앙·대원·신장 중 해당 동과 가까운 교량 또는 큰길을 함께 적어 주세요."] },
      ...
      { id: "arboretum-segyo", heading: "물향기수목원과 세교 생활권", paragraphs: ["물향기수목원·오산대역은 세교권 주소를 확인하는 서로 가까운 기준입니다.", "세교라는 이름 뒤에 동과 도로명, 단지명을 붙여 주세요."] },
  ...
  profile({
    ...
    sections: [
      { id: "jungnangcheon", heading: "중랑천을 따라 보는 도심 주소", paragraphs: ["중랑천은 의정부역·회룡역 주변 도심 주소를 확인하는 하천 기준입니다.", "의정부역·회룡역 중 가까운 곳에 동과 교량 또는 도로명을 함께 적습니다."] },
      ...
      { id: "dobongsan-west", heading: "도봉산 서쪽 주소", paragraphs: ["도봉산과 사패산 자락은 가능·호원 쪽 주소를 설명할 때 쓰는 기준입니다.", "가능·호원 중 해당 동과 가까운 역, 도로명을 함께 알려 주세요."] },
    ],
    sources: [
  ...
  profile({
    ...
    addressAxes: ["운정·교하", "금촌·월롱", "문산·임진강", "DMZ 인접 지역"],
    sections: [
      ...
      { id: "dmz-destination", heading: "DMZ 인접 지역의 목적지 확인", paragraphs: ["장단·군내 등 북부 일부는 일반 도심과 다른 출입 안내가 적용되는 목적지가 있습니다.", "가능 여부를 미리 단정하지 않고 장단·군내의 정확한 시설명과 공식 출입 안내를 확인합니다."] },
    ],
    sources: [
  ...
  profile({
    ...
    sections: [
      ...
      { id: "jinwi-stream", heading: "진위천을 기준으로 보는 주소", paragraphs: ["진위천은 시 중앙부를 남북으로 흐르며 여러 생활권을 가르는 하천 기준입니다.", "진위천 이름에 가까운 읍·동과 교량 또는 큰길을 함께 확인합니다."] },
  ...
  profile({
    ...
    sections: [
      { id: "hantan-north", heading: "한탄강 쪽 북부 주소", paragraphs: ["한탄강과 비둘기낭·주상절리 권역은 영북·관인·창수 쪽 주소의 기준입니다.", "영북·관인·창수 가운데 읍·면과 리 이름에 가까운 강변 도로를 더해 주세요."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "gamil-wirye", heading: "감일과 위례의 남부 주소", paragraphs: ["감일·감북·위례 쪽은 남한산성 방향과 인접 도시 지명이 함께 보이는 주소권입니다.", "감일·감북·위례 가운데 하남 안의 동 이름과 도로명을 분명히 적어 주세요."] },
  ...
  profile({
    ...
    sections: [
      ...
      { id: "baegun-cheonggye", heading: "백운호수와 청계산 쪽 주소", paragraphs: ["백운호수·청계산·청계사는 동쪽 주소를 확인할 때 서로 이어지는 기준입니다.", "청계·학의·내손 가운데 가까운 동과 도로명을 붙여 주세요."] },
      ...
      { id: "lake-rail-order", heading: "호수와 철도 기준을 섞지 않는 법", paragraphs: ["왕송호수·철도문화권과 백운호수·청계산권은 주소를 확인할 때 사용하는 기준점이 다릅니다.", "가까운 호수나 산을 고른 뒤 행정동과 도로명을 이어 적어 주세요."] },
    ],
    sources: [
